    ...
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${
        isOpen
          ? 'bg-[#8ECAE6] py-4'
          : isScrolled
            ? 'bg-white/80 backdrop-blur-xl py-3 border-b border-gray-200/50 shadow-[0_4px_30px_rgba(0,0,0,0.03)]'
            : 'bg-transparent py-5'
      }`}
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="flex items-center">
          ...
          >
            Karthika<span className="text-[#8ECAE6]">.</span>
          </a>
        </div>
        ...
        <div className="hidden md:flex space-x-7 lg:space-x-8">
          ...
          {navLinks.map((link) => (
            ...
            >
              ...
              <span className="absolute -bottom-1 left-0 w-0 h-[2px] bg-[#8ECAE6] transition-all duration-300 group-hover:w-full"></span>
            </a>
          ))}
        ...
        <div className="hidden md:block">
          <a
            ...
            className={`px-6 py-2.5 rounded-full text-sm font-black transition-all duration-500 ${
              isScrolled
                ? 'bg-gray-900 text-white hover:bg-[#8ECAE6] hover:shadow-[0_10px_25px_rgba(142,202,230,0.35)]'
      ...
      <div
        className={`md:hidden absolute top-full left-0 w-full transition-all duration-500 ease-in-out ${
          isOpen
            ? 'max-h-[460px] py-6 opacity-100 bg-[#8ECAE6] shadow-2xl'
        ...
        <div className="flex flex-col px-6 space-y-4">
          ...
          <div className="pt-2">
            <a
              href="#contact"
              onClick={() => setIsOpen(false)}
              className="inline-block px-6 py-3 rounded-full bg-white text-[#8ECAE6] font-black hover:bg-gray-950 hover:text-white transition-all duration-300 w-full text-center shadow-xl"
            >
              Hire Me
            </a>
          </div>
